(function(root){
  ...
  function validate(b) {
    ...
    return {id:b.id,gameId:b.gameId,home:b.home,away:b.away,team:b.team,created:b.created,season:b.season,week:b.week,stake:round(b.stake),odds:b.odds,book:String(b.book||'').slice(0,100),override:b.override,autoResult:b.autoResult};
  }
  ...
  function outcome(b) {
    ...
    const winProfit=round(b.stake*(b.odds>0?b.odds/100:100/Math.abs(b.odds)));
